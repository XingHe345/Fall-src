package dev.Fall.scripting.api;
...
public class ScriptManager implements Utils {
    ...
    private final File scriptDirectory = new File(mc.mcDataDir, "/Fluid/Scripts");
    ...
    public void reloadScripts() {
        HashMap<Object, Module> moduleList = Fall.INSTANCE.getModuleCollection().getModuleMap();
