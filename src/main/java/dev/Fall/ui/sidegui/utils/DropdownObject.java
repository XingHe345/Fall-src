    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (!openAnimation.isDone() || opened) {
            ...
            for (String option : options) {
                ...
                FluidFont18.drawString(option, getX() + 5, dropdownY + seperation + FluidFont18.getMiddleOfBox(getHeight()),
        ...
        FluidFont18.drawString("§l" + name + ":§r " + selection, getX() + 4, getY() + FluidFont18.getMiddleOfBox(getHeight()), textColor);
