...
import dev.Fall.utils.tuples.mutable.MutablePair;
...
public class TooltipObject implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (tooltip.contains("\n")) {
            ...
            MutablePair<Float, Float> whPair = FluidFont14.drawNewLineText(tooltip, x + 2, y + 2, ColorUtil.applyOpacity(-1, fadeAnim), 3);

            float additionalHeight = 0;
            if (additionalInformation != null) {
                additionalHeight = FluidFont14.drawWrappedText(additionalInformation, x + 2,
            ...
            width = FluidFont14.getStringWidth(tooltip) + 4;
            height = FluidFont14.getHeight() + 2;
            ...
            FluidFont14.drawCenteredString(tooltip, x + width / 2f, y + FluidFont14.getMiddleOfBox(height), ColorUtil.applyOpacity(-1, fadeAnim));
