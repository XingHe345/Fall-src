...
public class InfoPanel extends Panel {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        FluidBoldFont40.drawString("Info", getX() + 8, getY() + 8, getTextColor());
        FluidFont18.drawString("developed by cedo, tear, and senoe", getX() + 8, getY() + 30, ColorUtil.applyOpacity(getTextColor(), .3f));
