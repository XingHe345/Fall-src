package dev.Fall.ui.sidegui.panels.scriptpanel;
...
public class ScriptPanel extends Panel {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        FluidBoldFont40.drawString("Scripts", getX() + 8, getY() + 8, getTextColor());
            ...
            button.setClickAction(() -> {
                ...
                switch (button.getName()) {
                    case "Open documentation":
                        IOUtils.openLink("https://scripting.Fluid.dev");
                        break;
                    case "Open folder":
                        IOUtils.openFolder(Fall.INSTANCE.getScriptManager().getScriptDirectory());
                        break;
                }
            });
    ...
    public void refresh() {
        ...
        for (CloudScript cloudScript : Fall.INSTANCE.getCloudDataManager().getCloudScripts()) {
        ...
        for (Script script : Fall.INSTANCE.getScriptManager().getScripts()) {
