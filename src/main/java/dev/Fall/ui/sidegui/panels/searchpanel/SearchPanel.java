package dev.Fall.ui.sidegui.panels.searchpanel;
...
import dev.Fall.ui.sidegui.panels.configpanel.CloudConfigRect;
import dev.Fall.ui.sidegui.panels.scriptpanel.CloudScriptRect;
...
public class SearchPanel extends Panel {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        FluidFont18.drawString("Press ESC to return to the menu", getX() + 8, getY() + 8 + FluidBoldFont40.getHeight() + 2, ColorUtil.applyOpacity(getTextColor(), .3f));

        FluidBoldFont40.drawString("Search Results", getX() + 8, getY() + 8, getTextColor());
        ...
        String search = Fall.INSTANCE.getSideGui().getHotbar().searchField.getText();
        ...
        if (!searchTypeHold.equals(searchType)) {
            switch (searchType) {
                case "Configs":
                    ...
                    cloudConfigRects.addAll(Fall.INSTANCE.getSideGui().getConfigPanel().getCloudConfigRects());
                    break;
                case "Scripts":
                    cloudConfigRects.clear();
                    cloudScriptRects.clear();
                    cloudScriptRects.addAll(Fall.INSTANCE.getSideGui().getScriptPanel().getCloudScriptRects());
                    break;
            }
