...
public class SaveForm extends Form {
    ...
    private final TextField nameField = new TextField(FluidFont20);
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        FluidFont16.drawString("Enter a name for the local config",
        ...
        FluidFont24.drawString("Config name", nameField.getXPosition(),
