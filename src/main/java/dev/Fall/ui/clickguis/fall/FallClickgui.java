package dev.Fall.ui.clickguis.fall;
...
public class FallClickgui extends GuiScreen {
...
*/
        ...
        for (Category category : Category.values()) {
            ...
            if (hovering){
                RoundedUtil.drawRound(x + 10 - 55, catY + 17 + 50, rubikFont.size(20).getStringWidth(category.name) + 23, rubikFont.size(20).getHeight() + 5, 4, new Color(0,0,0, 200));
            }
            ...
            switch (category.name) {
                case "Combat": {
                    fluxICON20.drawString("G", x + 15 - 55, catY + 21 + 50, Color.white.brighter().brighter());
                }
                break;
                case "Movement":
                case "Render":
                ...
                case "Player":
                {
                    iconFont20.drawString(category.icon, x + 15 - 55, catY + 21 + 50, Color.white.brighter().brighter());
                }
                break;
            }
            rubikFont.size(20).drawString(category.name, x + 28 - 55, catY + 20 + 50, -1);
