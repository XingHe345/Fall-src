package dev.Fall.ui.clickguis.Record.panel.module;
...
public class SettingRender implements Screen {
    ...
    public SettingRender(Module module) {
        this.module = module;
    ...
    public void handle(int mouseX, int mouseY, int button, GuiEvents type) {
        ...
        for (Setting setting : module.getSettingsList()) {
            ...
            if (setting instanceof NumberSetting) {
                ...
                rubikFont.size(16).drawString(setting.name, x + 5, middleSettingY + 2, Color.GRAY.darker().brighter().brighter());
            ...
            if (setting instanceof ColorSetting) {
                ...
                rubikFont.size(16).drawString(setting.name, x + 5, middleSettingY, Color.GRAY.darker());
            ...
            if (setting instanceof StringSetting) {
                StringSetting stringSetting = (StringSetting) setting;
                RenderUtil.resetColor();
                rubikFont.size(16).drawString(setting.name, x + 5, middleSettingY, Color.GRAY.darker().brighter().brighter());
            ...
            if (setting instanceof ModeSetting) {
                ModeSetting modeSetting = (ModeSetting) setting;
                rubikFont.size(16).drawString(setting.name, x + 5,middleSettingY + 3, Color.GRAY.darker().brighter().brighter());
            ...
            if (setting instanceof MultipleBoolSetting) {
                ...
                rubikFont.size(16).drawString(setting.name, x + 6, middleSettingY + 3, Color.GRAY.darker().brighter().brighter());
