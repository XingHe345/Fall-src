package dev.Fall.ui.clickguis.Record;
...
public class NewClickGUI extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FluidBoldFont20.drawString("ClientName", x + 12, y + 20, Color.BLUE.brighter());
        FluidBoldFont20.drawString("ClientName", x + 13, y + 20, -1);
