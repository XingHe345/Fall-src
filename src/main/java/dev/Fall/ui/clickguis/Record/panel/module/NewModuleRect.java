...
public class NewModuleRect implements Screen {
    @Getter
    @Setter
    private int searchScore;
    public final Module module;
    private final Animation enableAnimation = new DecelerateAnimation(150, 1);
    private final SettingRender settingComponents;
    ...
    public NewModuleRect(Module module) {
        this.module = module;
        settingComponents = new SettingRender(module);
    }
    ...
    public void drawScreen(int mouseX, int mouseY) {
        typing = false;
        RoundedUtil.drawRound(x, y, rectWidth, rectHeight + 24, 5, new Color(0, 0, 0, 100));
        ...
        RoundedUtil.drawRound(x + rectWidth - 25, y + 5, 20, FluidFont20.getHeight() + 1, 4, module.isEnabled() ? new Color(8, 150, 250) : new Color(0,0,0,70));
        RenderUtil.drawGoodCircle(module.isEnabled() ? x + rectWidth - 9 : x + rectWidth - 21, y + 10, 4, -1);
        ...
        FluidFont20.drawString(module.getName(), x + 5, y + neverloseFont.size(20).getMiddleOfBox(20), -1);
