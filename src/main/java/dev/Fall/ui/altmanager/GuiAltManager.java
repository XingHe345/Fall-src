...
import dev.Fall.ui.altmanager.panels.AltPanel;
import dev.Fall.ui.altmanager.panels.InfoPanel;
import dev.Fall.ui.altmanager.panels.LoginPanel;
import dev.Fall.ui.altmanager.panels.MicrosoftInfoPanel;
...
public class GuiAltManager extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (currentSessionAlt != null) {
            ...
            FluidBoldFont22.drawCenteredString("Current Account", altRect.getX() + altRect.getWidth() / 2f,
                    altRect.getY() - (FluidBoldFont22.getHeight() + 5), -1);
        }
        ...
        Fall.INSTANCE.getModuleCollection().getModule(NotificationsMod.class).render();
        if (Alt.stage != 0) {
