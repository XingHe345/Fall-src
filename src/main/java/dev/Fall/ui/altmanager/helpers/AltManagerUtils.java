package dev.Fall.ui.altmanager.helpers;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import dev.Fall.Fall;
import dev.Fall.microsoft.MicrosoftLogin;
...
public class AltManagerUtils implements Utils {
    ...
    public static File altsFile = new File(Fall.DIRECTORY, "Alts.json");
    ...
    public void microsoftLoginAsync(Alt alt, String email, String password) {
        ...
        Multithreading.runAsync(() -> {
            ...
            if (auth != null) {
                ...
                writeAlts();
                Fall.INSTANCE.getAltManager().currentSessionAlt = finalAlt;
