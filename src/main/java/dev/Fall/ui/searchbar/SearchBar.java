...
public class SearchBar implements Screen {
    ...
    private final TextField searchField = new TextField(FluidFont18);
    private float alpha;
    ...
    public void keyTyped(char typedChar, int keyCode) {
        ...
        if (GuiScreen.isCtrlKeyDown() && keyCode == Keyboard.KEY_F) {
            ...
            Fall.INSTANCE.getModuleCollection().getModules().forEach(module -> module.setExpanded(false));
            return;
        }
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        FluidFont26.drawCenteredString("Do §lCTRL§r+§lF§r to open the search bar", sr.getScaledWidth() / 2f, sr.getScaledHeight() - 75,
                ColorUtil.applyOpacity(-1, (.3f * (1 - searchAlpha)) * openAnim));


        searchField.setWidth(200);
        searchField.setHeight(25);
        searchField.setFont(FluidFont24);
