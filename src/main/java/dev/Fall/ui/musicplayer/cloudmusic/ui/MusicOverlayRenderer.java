package dev.Fall.ui.musicplayer.cloudmusic.ui;
...
import dev.Fall.utils.render.GradientUtil;
...
public class MusicOverlayRenderer {
    ...
    private final AbstractFontRenderer fontRenderer = dev.Fall.utils.font.hanabi.FontUtil.getFromCustomFont(dev.Fall.utils.font.FontUtil.FluidFont18);
    ...
    public void renderOverlay(float x, float y) {
        ...
        if (MusicManager.INSTANCE.getCurrentTrack() != null && MusicManager.INSTANCE.getMediaPlayer() != null) {
            dev.Fall.utils.font.hanabi.FontUtil.getFromCustomFont(dev.Fall.utils.font.FontUtil.FluidFont18).drawString(MusicManager.INSTANCE.getCurrentTrack().name + " - " + MusicManager.INSTANCE.getCurrentTrack().artists, x + 32, y + 5, Color.WHITE.getRGB());
            dev.Fall.utils.font.hanabi.FontUtil.getFromCustomFont(dev.Fall.utils.font.FontUtil.FluidFont18).drawString(formatSeconds((int) readSecs) + "/" + formatSeconds((int) totalSecs), x + 32, y + 15, 0xffffffff);
        ...
        if (MusicManager.INSTANCE.lyric) {
            ...
            dev.Fall.utils.font.hanabi.FontUtil.getFromCustomFont(dev.Fall.utils.font.FontUtil.FluidFont18).drawString(s, (sr.getScaledWidth() - fontRenderer.getStringWidth(s)) / 2f, sr.getScaledHeight() - 40 - 10, col, true);
            s = MusicManager.INSTANCE.tlrcCur.contains("_EMPTY_") ? "Waiting......." : MusicManager.INSTANCE.tlrcCur;
            dev.Fall.utils.font.hanabi.FontUtil.getFromCustomFont(dev.Fall.utils.font.FontUtil.FluidFont18).drawString(s, (sr.getScaledWidth() - fontRenderer.getStringWidth(s)) / 2f, sr.getScaledHeight() - 30 - 10, col, true);
