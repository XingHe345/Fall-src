package dev.Fall.ui.musicplayer.cloudmusic.api;
...
import dev.Fall.ui.musicplayer.cloudmusic.util.ColUtils;
...
public enum CloudMusicAPI {
    ...
    public String QRKey() throws Exception {
        ...
        return ((JsonObject) JsonParser.parseString((String) this.httpRequest("https://music.163.com/weapi/login/qrcode/unikey", data, RequestType.POST)[0])).get("unikey").getAsString();
    }
    ...
    public Object[] QRState(String key) throws Exception {
        ...
        JsonObject result = (JsonObject) JsonParser.parseString((String) request[0]);
    ...
    public String[] requestLyric(String result) {
        String lyric = "";
        String transLyric = "";
        JsonObject phase = (JsonObject) JsonParser.parseString(result);
    ...
    public Object[] getDownloadUrl(String songId, long bitRate) throws Exception {
        ...
        JsonObject result = (JsonObject) JsonParser.parseString(json);
