package dev.Fall.ui.musicplayer.cloudmusic;
...
public class MusicManager extends ListenerAdapter {
    ...
    public final File artPicFolder;
    // 音乐封面缓存
    ...
    public CopyOnWriteArrayList<Track> playlist = new CopyOnWriteArrayList<>();
    // 用于缓存音乐的线程
    ...
    public MusicManager() {
        ...
        circleImage = new File(Minecraft.getMinecraft().mcDataDir.toString() + File.separator + Fall.NAME + File.separator + "circleImage");
