...
public class TrackSlot {
    ...
    public void draw(float x, float y, float mouseX, float mouseY) {
        ...
        this.x = x;
        this.y = y;
        AbstractFontRenderer font = dev.Fall.utils.font.hanabi.FontUtil.getFromCustomFont(dev.Fall.utils.font.FontUtil.FluidFont18);
        RoundedUtil.drawRound(x, y, width, height, 4, boxColor);
        GradientUtil.applyGradientHorizontal((int) (x + 2), (int) (y + 1), font.getStringWidth(track.name), font.getHeight(), 1, Fall.INSTANCE.getClientColor(), Fall.INSTANCE.getAlternateClientColor(), () ->
