...
import dev.Fall.event.impl.render.*;
...
public abstract class ListenerAdapter implements EventListener {
    ...
    public void onSyncCurrentItemEvent(SyncCurrentItemEvent event) {
    }
    ...
    private void start() {
        ...
        registerEvent(LookEvent.class, this::onLookEvent);
        registerEvent(MoveInputEvent.class, this::onMoveInputEvent);
        registerEvent(SyncCurrentItemEvent.class, this::onSyncCurrentItemEvent);
