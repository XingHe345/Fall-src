...
import dev.Fall.event.impl.game.RenderTickEvent;
...
public class EntityCulling extends Module {
    ...
    public EntityCulling() {
        super("FPS Boost", Category.RENDER, "Culls entities that are out of range");
    ...
    public static boolean renderItem(Entity stack) {
        if (!Fall.INSTANCE.isEnabled(EntityCulling.class)) return false;
