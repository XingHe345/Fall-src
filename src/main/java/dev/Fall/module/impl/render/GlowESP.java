...
import dev.Fall.event.impl.render.RenderChestEvent;
import dev.Fall.event.impl.render.RenderModelEvent;
...
public class GlowESP extends Module {
    ...
    private final ColorSetting playerColor = new ColorSetting("Player Color", Fall.INSTANCE.getClientColor());
    private final ColorSetting animalColor = new ColorSetting("Animal Color", Fall.INSTANCE.getAlternateClientColor());
    ...
    private final ShaderUtil outlineShader = new ShaderUtil("Fluid/Shaders/outline.frag");
