...
import dev.Fall.module.impl.movement.Sprint;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        Fall.INSTANCE.getEventProtocol().handleEvent(new UpdateEvent());
    ...
    public void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            ...
            Fall.INSTANCE.getEventProtocol().handleEvent(motionEvent);
    ...
    public void sendChatMessage(String message) {
        if (Fall.INSTANCE.getCommandHandler().execute(message) || message.startsWith(CommandHandler.CHAT_PREFIX)) {
            return;
        }

        PlayerSendMessageEvent playerSendMessageEvent = new PlayerSendMessageEvent(message);
        Fall.INSTANCE.getEventProtocol().handleEvent(playerSendMessageEvent);
    ...
    public void closeScreen() {
        ...
        NotificationManager.post(NotificationType.SUCCESS, "Done!", "Done!");
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        Fall.INSTANCE.getEventProtocol().handleEvent(pushOutOfBlockEvent);
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding()) {
            ...
            Fall.INSTANCE.getEventProtocol().handleEvent(slowDownEvent);
        ...
        if (this.isSprinting() && (this.movementInput.moveForward < f || this.isCollidedHorizontally || !flag3)) {
            if(!(Fall.INSTANCE.isEnabled(Sprint.class)) || Sprint.mode.is("Legit")) {
                this.setSprinting(false);
            }
        }
    ...
    public void jump() {
        ...
        Fall.INSTANCE.getEventProtocol().handleEvent(jumpEvent);
