...
import dev.Fall.event.impl.game.*;
import dev.Fall.event.impl.player.BlockEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException {
        ...
        this.gameSettings.guiScale = 2;
//        SoundUtils.playSound(new ResourceLocation("Fluid/Sounds/opening.wav"), .8f);
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Fall developer build");
    ...
    private void setInitialDisplayMode() throws LWJGLException {
        if (this.fullscreen) {
            ...
            //Fluid: Here is where u change the screen width and height on startup
    ...
    private void runGameLoop() throws IOException {
        ...
        if (!this.skipRenderWorld) {
            ...
            Fall.INSTANCE.getEventProtocol().handleEvent(renderTickEvent);
    ...
    public void shutdown() {
        Fall.INSTANCE.getEventProtocol().handleEvent(new GameCloseEvent());
        this.running = false;
    }
    ...
    public void clickMouse() {
        if (this.leftClickCounter <= 0) {
            ...
            Fall.INSTANCE.getEventProtocol().handleEvent(e);

//            this.thePlayer.swingItem();
            dev.Fall.viamcp.fixes.AttackOrder.sendConditionalSwing(this.objectMouseOver);
...
//                        this.playerController.attackEntity(this.thePlayer, this.objectMouseOver.entityHit);
                        dev.Fall.viamcp.fixes.AttackOrder.sendFixedAttack(this.thePlayer, this.objectMouseOver.entityHit);
                        break;
    ...
    public void rightClickMouse() {
        Fall.INSTANCE.getEventProtocol().handleEvent(new ClickEventRight());
    ...
    public void runTick() throws IOException {
        ...
        Fall.INSTANCE.getEventProtocol().handleEvent(tickEvent);
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        Fall.INSTANCE.getEventProtocol().handleEvent(new KeyPressEvent(k));
            ...
            if (this.thePlayer.isUsingItem()) {
                ...
                Fall.INSTANCE.getEventProtocol().handleEvent(blockEvent);
            ...
            Fall.INSTANCE.getEventProtocol().handleEvent(new BlockPlaceableEvent());
