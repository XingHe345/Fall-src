...
import dev.Fall.module.impl.render.TargetHUDMod;
...
public class ModelBiped extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        limbSwing = TargetHUDMod.renderLayers ? limbSwing : 0;
        limbSwingAmount = TargetHUDMod.renderLayers ? limbSwingAmount : 0;
        ...
        if (this.swingProgress > -9990.0F) {
            float swingProgressCustom = TargetHUDMod.renderLayers ? this.swingProgress : 0;
            float f = swingProgressCustom;
            ...
            float f2 = MathHelper.sin(swingProgressCustom * (float) Math.PI) * -(this.bipedHead.rotateAngleX - 0.7F) * 0.75F;
            this.bipedRightArm.rotateAngleX = (float) ((double) this.bipedRightArm.rotateAngleX - ((double) f1 * 1.2D + (double) f2));
            this.bipedRightArm.rotateAngleY += this.bipedBody.rotateAngleY * 2.0F;
            this.bipedRightArm.rotateAngleZ += MathHelper.sin(swingProgressCustom * (float) Math.PI) * -0.4F;
        }
