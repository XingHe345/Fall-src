...
public class GuiContainerCreative extends InventoryEffectRenderer {
    ...
    protected void handleMouseClick(Slot slotIn, int slotId, int clickedButton, int clickType) {
        ...
        if (slotIn == null && selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && clickType != 5) {
            InventoryPlayer inventoryplayer1 = this.mc2.thePlayer.inventory;
            ...
            for (int j = 0; j < this.mc2.thePlayer.inventoryContainer.getInventory().size(); ++j) {
                this.mc2.playerController.sendSlotPacket((ItemStack) null, j);
            }
        } else if (selectedTabIndex == CreativeTabs.tabInventory.getTabIndex()) {
            if (slotIn == this.field_147064_C) {
                this.mc2.thePlayer.inventory.setItemStack((ItemStack) null);
                ...
                this.mc2.thePlayer.dropPlayerItemWithRandomChoice(itemstack, true);
                this.mc2.playerController.sendPacketDropItem(itemstack);
                ...
                this.mc2.thePlayer.inventoryContainer.slotClick(slotIn == null ? slotId : ((GuiContainerCreative.CreativeSlot) slotIn).slot.slotNumber, clickedButton, clickType, this.mc2.thePlayer);
                this.mc2.thePlayer.inventoryContainer.detectAndSendChanges();
            }
        } else if (clickType != 5 && slotIn.inventory == field_147060_v) {
            InventoryPlayer inventoryplayer = this.mc2.thePlayer.inventory;
            ...
            if (clickType == 2) {
                if (itemstack2 != null && clickedButton >= 0 && clickedButton < 9) {
                    ...
                    this.mc2.thePlayer.inventory.setInventorySlotContents(clickedButton, itemstack7);
                    this.mc2.thePlayer.inventoryContainer.detectAndSendChanges();
                }
            ...
            if (clickType == 4) {
                if (itemstack2 != null) {
                    ...
                    this.mc2.thePlayer.dropPlayerItemWithRandomChoice(itemstack3, true);
                    this.mc2.playerController.sendPacketDropItem(itemstack3);
                }
            ...
            if (Container.getDragEvent(clickedButton) == 2) {
                ...
                this.mc2.playerController.sendSlotPacket(itemstack4, slotIn.slotNumber - this.inventorySlots.inventorySlots.size() + 9 + 36);
            }
        }
    }
    ...
    private void updateCreativeSearch() {
        ...
        while (iterator.hasNext()) {
            ...
            for (String s : itemstack.getTooltip(this.mc2.thePlayer, this.mc2.gameSettings.advancedItemTooltips)) {
    ...
    private void setCurrentCreativeTab(CreativeTabs p_147050_1_) {
        ...
        if (p_147050_1_ == CreativeTabs.tabInventory) {
            Container container = this.mc2.thePlayer.inventoryContainer;
    ...
    protected void renderToolTip(ItemStack stack, int x, int y) {
        if (selectedTabIndex == CreativeTabs.tabAllSearch.getTabIndex()) {
            List<String> list = stack.getTooltip(this.mc2.thePlayer, this.mc2.gameSettings.advancedItemTooltips);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        for (CreativeTabs creativetabs1 : CreativeTabs.creativeTabArray) {
            this.mc2.getTextureManager().bindTexture(creativeInventoryTabs);
