...
import dev.Fall.module.impl.player.ChestStealer;
...
public abstract class GuiContainer extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if(!Fall.INSTANCE.isEnabled(InventoryMove.class)) {
    ...
    private void drawSlot(Slot slotIn) {
        ...
        ItemStack itemstack1 = this.mc2.thePlayer.inventory.getItemStack();
        String s = null;
        ...
        if (itemstack == null) {
            ...
            if (s1 != null) {
                TextureAtlasSprite textureatlassprite = this.mc2.getTextureMapBlocks().getAtlasSprite(s1);
                GlStateManager.disableLighting();
    ...
    private void updateDragSplitting() {
        ItemStack itemstack = this.mc2.thePlayer.inventory.getItemStack();
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        boolean flag = mouseButton == this.mc2.gameSettings.keyBindPickBlock.getKeyCode() + 100;
        ...
        if (mouseButton == 0 || mouseButton == 1 || flag) {
            ...
            if (this.mc2.gameSettings.touchscreen && flag1 && this.mc2.thePlayer.inventory.getItemStack() == null) {
