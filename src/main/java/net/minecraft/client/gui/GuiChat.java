...
import dev.Fall.module.impl.render.SpotifyMod;
...
public class GuiChat extends GuiScreen {
    ...
    public void initGui() {
        ...
        if (spotifyMod == null) {
            spotifyMod = (SpotifyMod) Fall.INSTANCE.getModuleCollection().get(SpotifyMod.class);
            arraylistMod = (ArrayListMod) Fall.INSTANCE.getModuleCollection().get(ArrayListMod.class);
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        abstractFontRenderer = WeiLaiYuan.size(20);
        ...
        HUDMod hudMod = (HUDMod) Fall.INSTANCE.getModuleCollection().get(HUDMod.class);
        ...
        //RoundedUtil.drawRound(width / 2f - 50, 20, 100, 20, 10, new Color(0, 0, 0, 100));
        //FontUtil.FluidBoldFont20.drawCenteredString("Reset Widget", width / 2f, 20 + FontUtil.FluidBoldFont20.getMiddleOfBox(20), -1);
