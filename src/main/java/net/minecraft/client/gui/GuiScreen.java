...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback, Utils {
    ...
    public void handleMouseInput() throws IOException {
        int i = Mouse.getEventX() * this.width / this.mc2.displayWidth;
        int j = this.height - Mouse.getEventY() * this.height / this.mc2.displayHeight - 1;
    ...
    public void drawBackground(int tint) {
        ...
        this.mc2.getTextureManager().bindTexture(optionsBackground);
