...
import dev.Fall.utils.server.ServerUtils;
import dev.Fall.utils.server.ban.BanUtils;
...
public class GuiDisconnected extends GuiScreen {
    ...
    public GuiDisconnected(GuiScreen screen, String reasonLocalizationKey, IChatComponent chatComp) {
        ...
        Alt activeAlt = Fall.INSTANCE.getAltManager().currentSessionAlt;
        if (activeAlt != null) {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 0) {
            ...
            mc2.displayGuiScreen(Fall.INSTANCE.getAltManager());
        } else if (button.id == 2) {
