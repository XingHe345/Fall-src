...
public class RenderManager {
    ...
    public void cacheActiveRenderInfo(World worldIn, IFontRenderer textRendererIn, Entity livingPlayerIn, Entity pointedEntityIn, GameSettings optionsIn, float partialTicks) {
